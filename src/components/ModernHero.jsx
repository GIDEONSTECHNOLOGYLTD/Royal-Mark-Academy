...
const ModernHero = () => {
  ...
  return (
    <section className="relative h-screen overflow-hidden">
      ...
      {/* Background Overlay - Balanced for readability */}
      <div className="absolute inset-0" style={{ backgroundColor: 'rgba(0, 0, 0, 0.5)', position: 'absolute', top: 0, right: 0, bottom: 0, left: 0, zIndex: 1 }}></div>
